...
Write-Host ' - - - - - - - - - - - - - - - - - - - - - - - - - '
#$AzureRepoName = "CloudQuickLabsGitHub"
#$GitHubCloneURL = "dev.azure.com/CloudQuickLabs/CloudQuickLabsGitHub/_git/CloudQuickLabsGitHub"
#$GitHubCloneURL = "github.com/RekhuGopal/CloudQuickLabsGitHub.git"
